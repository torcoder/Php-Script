...
$id = $_GET['id'];
$query = $baglanti->prepare("SELECT * FROM ofis WHERE id=?");
...
?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <!-- Approach -->
                            <form name="updateOffice" id="updateOffice">
    ...
    $(document).ready(function() {
        $('#updateOffice').on('submit', function(e) {
            $.ajax({
                url: 'islem.php',
                data: $(this).serialize() + '&form_name=' + $("#updateOffice").attr("name"),
                type: 'POST',
