...
$query1 = $baglanti->prepare("SELECT * FROM map WHERE id=1");
$query1->execute();
...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <!-- Approach -->
                            <form name="addOffice" id="addOffice">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="card-body">
                                                <p>TR | Ofis Adı</p>
                                                <div class="mb-0">
                                                    <input class="form-control" type="text" name="ofis"
                                        ...
                                        <div class="col-6">
                                            <div class="card-body">
                                                <p>EN | Ofis Adı</p>
                                                <div class="mb-0">
                                                    <input class="form-control" type="text" name="en_ofis"
                                                        placeholder="Bu alana ofis adı yazınız!"
                                                        aria-label="default input example">
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-0">
                                            <input class="form-control" type="text" name="adres"
                                                placeholder="Bu alana adres yazınız!"
                                                aria-label="default input example">
                                        </div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <!-- Approach -->
                            <form name="updateMap" id="updateMap">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
    ...
    $(document).ready(function() {
        $('#addOffice').on('submit', function(e) {
            $.ajax({
                url: 'islem.php',
                data: $(this).serialize() + '&form_name=' + $("#addOffice").attr("name"),
                type: 'POST',
            ...
            e.preventDefault();
            $('#addOffice').trigger("reset");
        });

        $('#updateMap').on('submit', function(e) {
            $.ajax({
                url: 'islem.php',
                data: $(this).serialize() + '&form_name=' + $("#updateMap").attr("name"),
                type: 'POST',
                success: function(response) {
                    Swal.fire({
                        icon: 'success',
