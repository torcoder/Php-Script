                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Galeri SEO Ayarlamaları | TR</h6>
                                </div>
                                <div class="card-body">
                                    <p>Düzenleme firmamız tarafından yapılacaktır. Ekstra müdehale etmemeniz önerilir.
                                    </p>
                                </div>
                                <form id="postform1" name="galeri_seo">
                                    <div class="card-body">
                                        <p>Description(Max 160 karakter uzunluğunda olmalıdır.)</p>
                                        <div class="mb-0">
                                            <textarea class="form-control" placeholder="Bu alana açıklama yazınız!"
                                                id="exampleFormControlTextarea1" rows="1" name="galeri_desc"
                                                maxlength="160"><?php echo $row['galeri_desc'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p>Keywords</p>
                                        <div class="mb-0">
                                            <input class="form-control" type="text" placeholder="Bu alana yazınız!"
                                                aria-label="default input example" name="galeri_key"
                                                value="<?php echo $row['galeri_key'] ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Galeri SEO Ayarlamaları | EN</h6>
                                </div>
                                <div class="card-body">
                                    <p>Düzenleme firmamız tarafından yapılacaktır. Ekstra müdehale etmemeniz önerilir.
                                    </p>
                                </div>
                                <form id="postform2" name="galeri_seo_en">
                                    <div class="card-body">
                                        <p>Description(Max 160 karakter uzunluğunda olmalıdır.)</p>
                                        <div class="mb-0">
                                            <textarea class="form-control" placeholder="Bu alana açıklama yazınız!"
                                                id="exampleFormControlTextarea1" name="galeri_desc_en" rows="1"
                                                maxlength="160"><?php echo $row['galeri_desc_en'] ?>
</textarea>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="mb-0">
                                            <input class="form-control" type="text" placeholder="Bu alana yazınız!"
                                                aria-label="default input example" name="galeri_key_en"
                                                value="<?php echo $row['galeri_key_en'] ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
