            ...
            <div class="row">
                <div class="col-lg-6  mt-5 mb-5 pt-5 pb-5">
                    <div class="mt-5 mb-5 pt-5 pb-5" data-aos="fade-left" data-aos-duration="1500">
                        <p style="font-weight:900; font-size:35pt; color:white">Çerçeve Kapak Profilleri</p>
                        <nav aria-label="breadcrumb" style="color:white!important;">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page" style=" font-size:16pt;">Ürünler-İç-Sayfa</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-6 py-3">
                    <div class="card bv-shadow-2">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Çerçeve Kapak Profilleri</h5>
                                    <hr>
                                    <p class="card-text">
                                        <strong>Model No: </strong>DM 2214
                                    </p>
                                    <p class="card-text">
                                        <strong>Detay: </strong>Eloksal, Parlak, Titan
                                    </p>
                                </div>
                                <div>
                                    <a href="urunler-ic-sayfa-resimler.php"><button type="button" class="btn btn-primary btn-block btn-md" style="width: 100%; background-color:#e7401c!important;">İncele</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
